...
const VALUE_PROPS = (lang) => [
  { icon: ShieldCheck, t: bi("Armada Terawat", "Well-Maintained Fleet", lang), d: bi("KIR, pajak, dan servis terjadwal. Setiap unit dipantau kelaikannya sebelum jalan.", "Inspection, taxes and scheduled servicing. Every unit's roadworthiness is checked before it departs.", lang), tag: bi("Kelaikan terjaga", "Always roadworthy", lang) },
  { icon: MapPin, t: bi("Pelacakan Real-time", "Real-time Tracking", lang), d: bi("Pantau posisi & estimasi tiba perjalanan Anda langsung dari peta, kapan saja.", "Track your trip's position & ETA straight from the map, anytime.", lang), tag: bi("GPS live", "Live GPS", lang) },
  { icon: Headset, t: bi("Layanan Responsif", "Responsive Service", lang), d: bi("Tim operasional siap membantu penawaran, penjadwalan, dan kebutuhan trip Anda.", "Our operations team is ready to help with quotes, scheduling and your trip needs.", lang), tag: bi("Support 24/7", "24/7 support", lang) },
];

const STAT_ICONS = { fleet: Bus, destinations: Globe2, rating: Star, service: Clock };

const TRUST = (lang) => [
  { icon: BadgeCheck, t: bi("Sertifikasi CHSE", "CHSE Certified", lang), d: bi("Protokol kebersihan & keselamatan", "Cleanliness & safety protocols", lang) },
  { icon: ShieldCheck, t: bi("KIR & Pajak Aktif", "Valid Inspection & Tax", lang), d: bi("Legalitas unit selalu diperbarui", "Vehicle legality always up to date", lang) },
  { icon: Wrench, t: bi("Servis Terjadwal", "Scheduled Servicing", lang), d: bi("Perawatan berkala tiap armada", "Regular maintenance for every unit", lang) },
  { icon: Navigation, t: bi("GPS Tracking", "GPS Tracking", lang), d: bi("Pelacakan rute & ETA real-time", "Real-time route & ETA tracking", lang) },
];

const HERO_CHIPS = (lang) => [bi("Driver berpengalaman", "Experienced drivers", lang), bi("CHSE / KIR", "CHSE / inspection", lang), bi("Harga transparan", "Transparent pricing", lang)];
